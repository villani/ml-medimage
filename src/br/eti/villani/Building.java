...
import br.eti.villani.util.IrmaCode;
import br.eti.villani.util.LogBuilder;
import br.eti.villani.util.RelationBuilder;
import br.eti.villani.util.XmlIrmaCodeBuilder;
...
/**
 * Creates four ARFF bases for each subset. One for each features extraction techniques.
...
public class Building {
	...
	/**
	 * @param id Experiment identification.
	 * @param log Experiment logger.
	 * @param entradas Experiment inputs
	 */
	public static void run(String id, LogBuilder log, TreeMap<String, String> entradas) {
		...
		if (hasSIFT){
			for (int i = 0; i < ns; i++) {
				...
				// In�cio - Identifica��o dos pontos-chave para c�lculo do histograma SIFT
...
//						instancia.setDataset(instancias);
				...
				// Fim - Identifica��o dos pontos-chave para c�lculo do histograma SIFT
