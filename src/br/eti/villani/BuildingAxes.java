...
/**
 * From each theses fourth bases will be getted more four sub-bases. One fo each IRMA axis (Techinal, Directional, Anatomical and Biological).
		...
		for(String tecnica: tecnicas){
			...
			for(String eixo: eixos){
				for(int i = 0; i < ns; i++){
					...
					try{
						// Remove os atributos r�tulos de outros eixos
