...
/**
 * In each iteration, the ARFF bases are used of the following way:<br>
 * <ol>
 * <li>Each base from each extractor features must be the train set used to create the classifier's model.</li>
 * <li>The bases remaining from respective extractor features will be the tests sets used to evaluation of the created model. </li>
 * </ol>
 * For the classifiers evaluation will be considered the measures means obtained from evaluation of the nine tests set in each iteration for each features extractor.
